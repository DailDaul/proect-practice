...
В рамках проектной практики для реализации технологии была выбрана База данных ([DataBase](https://github.com/codecrafters-io/build-your-own-x?tab=readme-ov-file#build-your-own-database))
