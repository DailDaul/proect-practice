...
Описание: Устанавливает значение для указанного ключа.
...
* GET key:
Описание: Возвращает значение, связанное с указанным ключом.
Аргументы:
key: Строка, представляющая ключ.
...
* DELETE key:
Описание: Удаляет указанный ключ.
Аргументы:
key: Строка, представляющая ключ.
Возвращаемое значение: Целое число 1 в случае успеха.

* MSET key1 value1 key2 value2 …:
Описание: Устанавливает значения для нескольких ключей.
Аргументы:
...
* MGET key1 key2 …:
Описание: Возвращает значения для нескольких ключей.
Аргументы:
key1: Строка, представляющая первый ключ.
key2: Строка, представляющая второй ключ.
И так далее.
...
* FLUSH:
Описание: Удаляет все ключи из базы данных.
Аргументы: Нет.
Возвращаемое значение: Целое число, например 1, в случае успеха.
а также такие типы данных:
...
Таким образом, если пользователь захочет, например, выполнить команду GET с аргументом mykey. Команда GET - это строка длиной 3 байта, а ключ mykey - это строка длиной 5 байт, то ему достаточно написать 
