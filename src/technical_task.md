...
#### 7. Модификация
В рамках темы, которая была выбрана для вариативной части, модификация заключалась в почти полном переписывании кода, т.к. то, что было представлено в предоставленном руководстве, было нерабочим.
