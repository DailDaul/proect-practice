...
#### 7. Модификация
В рамках темы, которая была выбрана для вариативной части, модификация заключалась в почти полном переписывании кода, т.к. то, что было представлено в предоставленном руководстве, было нерабочим. Также, помимо этого, была модифицирована работа сервера и клиента - был улучшем формат получения сервером ответов.
